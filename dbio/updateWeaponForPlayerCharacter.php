...
function updateWeaponForPlayerCharacter(\PDO $pdo, $input, &$errors, &$log) {
    ...
    $log[] = 'craftStatus: ' . $input[CRAFT_STATUS];
    ...
    if ($input[MISSILE_WEAPON_TYPE] == OPTIONAL_INTEGER_PARAMETER) {
        ...
        $log[] = 'missileAttacksPerRound: ' . $input[MISSILE_ATTACKS_PER_ROUND];
        ...
        if ($input[MISSILE_HIT_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileHitBonus: ' . $input[MISSILE_HIT_BONUS];
        }
        ...
        if ($input[MISSILE_DAMAGE_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileDamageBonus: ' . $input[MISSILE_DAMAGE_BONUS];
        }
        ...
        if ($input[MISSILE_SPEC1_HIT_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileSpec1HitBonus: ' . $input[MISSILE_SPEC1_HIT_BONUS];
        }
        ...
        if ($input[MISSILE_SPEC1_DAMAGE_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileSpec1DamageBonus: ' . $input[MISSILE_SPEC1_DAMAGE_BONUS];
        }
        ...
        if ($input[MISSILE_SPEC1_DESCRIPTION] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileSpec1Description: ' . $input[MISSILE_SPEC1_DESCRIPTION];
        }
        ...
        if ($input[MISSILE_SPEC2_HIT_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileSpec2HitBonus: ' . $input[MISSILE_SPEC2_HIT_BONUS];
        }
        ...
        if ($input[MISSILE_SPEC2_DAMAGE_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileSpec2DamageBonus: ' . $input[MISSILE_SPEC2_DAMAGE_BONUS];
        }
        ...
        if ($input[MISSILE_SPEC2_DESCRIPTION] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileSpec2Description: ' . $input[MISSILE_SPEC2_DESCRIPTION];
        }
        ...
        if ($input[MISSILE_SPEC3_HIT_BONUS] == OPTIONAL_INTEGER_PARAMETER) {
            ...
            $log[] = 'missileSpec3HitBonus: ' . $input[MISSILE_SPEC3_HIT_BONUS];
        }
        ...
        if ($input[MISSILE_SHORT_RANGE] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileShortRange: ' . $input[MISSILE_SHORT_RANGE];
        }
        ...
        if ($input[MISSILE_MEDIUM_RANGE] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileMediumRange: ' . $input[MISSILE_MEDIUM_RANGE];
        }
        ...
        if ($input[MISSILE_LONG_RANGE] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileLongRange: ' . $input[MISSILE_LONG_RANGE];
        }
        ...
        if ($input[MISSILE_ADDITIONAL_TEXT] == OPTIONAL_STRING_PARAMETER) {
            ...
            $log[] = 'missileAdditionalText: ' . $input[MISSILE_ADDITIONAL_TEXT];
        }
    }
