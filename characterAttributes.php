<?php
    ...
    const CHARACTER_RACE_ID = 'raceId';
    const CHARACTER_RACE = 'race';
    const CHARACTER_GENDER =  'genderIn';
    const CHARACTER_MOVEMENT = 'movement';
    ...
    const CHARACTER_SECONDARY_CLASS = 'characterClass2';
