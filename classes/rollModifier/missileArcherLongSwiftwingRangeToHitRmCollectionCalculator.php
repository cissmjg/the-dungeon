<?php
    ...
    class MissileArcherLongSwiftwingRangeToHitRmCollectionCalculator extends MissileLongSwiftwingRangeToHitRmCollectionCalculator {
        ...
        public function __construct() {
            ...
            // Long Range To Hit modifiers
            $this->to_hit_bonus[1] = 0;
            $this->to_hit_bonus[2] = 0;
            $this->to_hit_bonus[3] = 0;
            $this->to_hit_bonus[4] = 0;
            $this->to_hit_bonus[5] = 0;
            $this->to_hit_bonus[6] = 0;
            $this->to_hit_bonus[7] = 0;
            $this->to_hit_bonus[8] = 0;
            $this->to_hit_bonus[9] = 0;
            $this->to_hit_bonus[10] = 0;
            $this->to_hit_bonus[11] = 0;
            $this->to_hit_bonus[12] = 1;
            $this->to_hit_bonus[13] = 1;
        ...
        public function gather(CharacterDetails $character_details, PlayerCharacterSkillSet $player_character_skill_set, PlayerCharacterWeapon $player_character_weapon, AttributeMetadata $attribute_metadata) {
            ...
            $this->rm_long_collection->add($rm_to_hit);
        }
