<?php
    ...
    class WeaponFocusGreaterAccuracy extends CandidateWeaponSkill {
        protected function getSkillId() {
            return WEAPON_FOCUS_GREATER_ACCURACY;
        }
        ...
        private $restricted_skills_satisfied;
         ...
         public function prerequisiteSkillsSatisfied(\PlayerCharacterSkillSet $player_character_skill_set, \SkillDetail $skill_detail) {
            ...
            $this->skill_prereq_satisfied = count($player_character_skill_set->getAllSkillInstancesForWeapon(WEAPON_FOCUS_ACCURACY, $this->getWeaponProficiencyValue())) > 0 ? true : false;
